            ...
            if ($action === "add") {
                ...
                if (is_null($member)) {
                    Session::flash('alert', [
                        ...
                        'message' => "The character you selected does not have account registered with Sica Auth. Please have the character log into Sica Auth first, then attempt to add them to the group",
                        'type' => 'danger',
                        'close' => 1
                    ]);
                    return redirect(route('settings.group', ['group' => $group->id]));
                ...
                if ($scope === "accessor") {
                    ...
                    if (Request::has('select')) {
                        ...
                        if (is_null($isMember)) {
                            Session::flash('alert', [
                                'header' => "Not A Member",
                                'message' => "That character who you are attempting to grant access to is not a member of ESIKnife. Please have them register for Sica Auth, and then you will be able to share your data with them.",
                                'type' => 'danger',
                                'close' => 1
                            ]);
                            return redirect(route('settings.access'));
